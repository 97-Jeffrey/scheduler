...
describe("Application", () => {
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    await waitForElement(() =>
      getByText(appointment, "Cannot save, try again please")
    );

    expect(getByText(appointment, "Cannot save, try again please")
    ).toBeInTheDocument();
  ...
  it("shows the delete error when failing to delete an existing appointment", async () => {
    ...
    await waitForElement(() =>
      getByText(appointment, "Cannot delete, try again please"));

    expect(getByText(appointment, "Cannot delete, try again please")
    ).toBeInTheDocument();
  })
})
